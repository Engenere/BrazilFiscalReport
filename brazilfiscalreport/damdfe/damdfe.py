...
from .damdfe_conf import URL, tp_ambiente, tp_emissao, tp_emitente
...
class Damdfe(xFPDF):
    ...
    def _draw_receipt(self):
        ...
        # Modelo
        self.set_xy(x=x_margin + 2, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="MODELO",
        ...
        self.set_xy(x=x_margin + 5, y=y_middle + 3)
        self.multi_cell(
            w=100,
            h=3,
            text=self.model,
        ...
        # Série
        self.set_xy(x=x_margin + 17, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="SÉRIE",
        ...
        self.set_xy(x=x_margin + 19, y=y_middle + 3)
        self.multi_cell(
            w=100,
            h=3,
            text=self.serie,
        ...
        # Número
        self.set_xy(x=x_margin + 30, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="NÚMERO",
        ...
        # FL
        self.set_xy(x=x_margin + 47, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="FL",
        ...
        # Teste
        self.set_xy(x=x_margin + 47, y=y_middle + 3)
        self.multi_cell(
            w=100,
            h=3,
            text="1/1",
        ...
        self.set_xy(x=x_margin + 56, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="DATA E HORA",
        ...
        # Teste Colocar Horas Depois
        self.set_xy(x=x_margin + 58, y=y_middle + 3)
        self.multi_cell(
            w=100,
            h=3,
            text=f"{self.dt}",
        ...
        # UF CARREG
        self.set_xy(x=x_margin + 71, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="UF CARREG",
        ...
        self.set_xy(x=x_margin + 76, y=y_middle + 3)
        self.multi_cell(
            w=100,
            h=3,
            text=self.uf_carreg,
        ...
        # UF DESCARREG
        self.set_xy(x=x_margin + 85, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="UF DESCARREG",
        ...
        self.set_xy(x=x_margin + 90, y=y_middle + 3)
        self.multi_cell(
            w=100,
            h=3,
        ...
        # QR_CODE
        self.qr_code = extract_text(self.inf_mdfe_supl, "qrCodMDFe")
        qr = qrcode.QRCode(
            version=1,
        ...
        self.image(svg_img_bytes, x=x_margin + 108 + 1, y=num_y + 35, w=82, h=12.5)
        ...
        self.draw_vertical_lines_left(
            start_y=y_margin + 28, end_y=y_margin + 28 + 7, num_lines=7
        )

        y_middle = y_margin + 35
        self.line(x_margin, y_middle, x_margin + page_width - 0.5, y_middle)
        self.line(x1=x_margin + 24, y1=40, x2=x_margin + 24, y2=47)
        self.line(x1=x_margin + 64, y1=40, x2=x_margin + 64, y2=47)
        ...
        self.line(x_margin, y_middle, x_middle, y_middle)
        self.line(x1=x_margin + 44, y1=47, x2=x_margin + 44, y2=55)
        self.line(x1=x_margin + 70, y1=47, x2=x_margin + 70, y2=55)
    ...
    def _draw_header(self):
        ...
        # QTD. CT-e
        self.set_font(self.default_font, "", 6.5)
        self.set_xy(x=x_margin + 7, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="QTD. CT-e",
        ...
        # Vê qual TAG tem essa informação
        self.set_xy(x=x_margin + 7, y=y_middle + 4)
        self.multi_cell(
            w=100,
            h=3,
            text="",
        ...
        # QTD. NF-e
        self.set_xy(x=x_margin + 32, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="QTD. NF-e",
        ...
        self.set_xy(x=x_margin + 36, y=y_middle + 3)
        self.multi_cell(
            w=100,
            h=3,
            text=self.qtd_nfe,
        ...
        # PESO TOTAL
        self.set_xy(x=x_margin + 55, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="PESO TOTAL",
        ...
        self.set_xy(x=x_margin + 57, y=y_middle + 3)
        self.multi_cell(
            w=100,
            h=3,
            text=self.qtd_carga,
        ...
        # VALOR TOTAL
        self.set_xy(x=x_margin + 78, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="VALOR TOTAL",
        ...
        self.set_xy(x=x_margin + 80, y=y_middle + 3)
        self.multi_cell(
            w=100,
            h=3,
        ...
        # UF
        self.set_font(self.default_font, "B", 7)
        self.set_xy(x=x_margin + 34, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="UF",
        ...
        self.set_font(self.default_font, "", 7)
        self.set_xy(x=x_margin + 34, y=y_middle + 4)
        self.multi_cell(
            w=100,
            h=3,
            text=self.modal_uf,
        ...
        # RNTRC
        self.set_font(self.default_font, "B", 7)
        self.set_xy(x=x_margin + 57, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="RNTRC",
        ...
        self.set_font(self.default_font, "", 7)
        self.set_xy(x=x_margin + 56, y=y_middle + 4)
        self.multi_cell(
            w=100,
            h=3,
            text=self.rntrc,
        ...
        # RENAVAM
        self.set_font(self.default_font, "B", 7)
        self.set_xy(x=x_margin + 80, y=y_middle)
        self.multi_cell(
            w=100,
            h=3,
            text="RENAVAM",
        ...
        self.set_font(self.default_font, "", 7)
        self.set_xy(x=x_margin + 79, y=y_middle + 4)
        self.multi_cell(
            w=100,
            h=3,
            text=self.renavam,
        ...
        # CPF
        self.set_xy(x=y_middle + 45, y=y_middle - 2.8)
        self.multi_cell(
            w=100,
            h=3,
            text="CPF",
        ...
        self.set_xy(x=y_middle + 40, y=y_middle + 0.5)
        self.multi_cell(
            w=100,
            h=3,
        ...
        # CONDUTORES
        self.set_xy(x=y_middle + 90, y=y_middle - 2.8)
        self.multi_cell(
            w=100,
            h=3,
            text="CONDUTORES",
        ...
        self.set_xy(x=y_middle + 88, y=y_middle + 0.5)
        self.multi_cell(
            w=100,
            h=3,
    ...
    def _draw_voucher_information(self):
        ...
        self.rect(x=x_margin, y=y_margin + 10.5, w=page_width - 0.5, h=40, style="")
        ...
        self.line(x1=x_margin + 30, y1=123, x2=x_margin + 30, y2=127)
        self.line(x1=x_margin + 92, y1=123, x2=x_margin + 92, y2=127)
        self.line(x1=x_margin + 130, y1=123, x2=x_margin + 130, y2=127)
        ...
        # Informações dos Docs. Fiscais Vinculados ao Manifesto
        self.set_xy(x=x_margin + 130, y=y_middle + 1)
        self.multi_cell(
            w=100,
            h=3,
            text="INFORMAÇÕES DOS DOCS. FISCAIS VINCULADOS AO MANIFESTO",
    ...
    def _draw_insurance_information(self):
        ...
        self.rect(x=x_margin, y=y_margin + 6, w=page_width - 0.5, h=44, style="")
        y_middle = y_margin + 9
        self.line(x_margin, y_middle, x_margin + page_width - 0.5, y_middle)
        self.set_xy(x=(page_width - 45) / 2, y=y_middle - 1.5)
        self.set_font(self.default_font, "B", 7)
        self.multi_cell(
            w=100, h=0, text="INFORMAÇÕES SOBRE OS SEGUROS", border=0, align="L"
        )

        self.rect(x=x_margin, y=y_margin + 50, w=page_width - 0.5, h=45, style="")
        y_middle = y_margin + 55
        self.line(x_margin, y_middle, x_margin + page_width - 0.5, y_middle)
        ...
        self.rect(x=x_margin, y=y_margin + 95, w=page_width - 0.5, h=45, style="")
        y_middle = y_margin + 100
        self.line(x_margin, y_middle, x_margin + page_width - 0.5, y_middle)
